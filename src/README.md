...
### 1. Coverage Summary with --coverage-text

```./vendor/bin/phpunit --coverage-text=coverage.txt```

### 2. Coverage Percentage with --coverage-clover

```./vendor/bin/phpunit --coverage-clover=coverage.xml```

### 3. Coverage in Percentage Only with lcov

```./vendor/bin/phpunit --coverage-clover=coverage/clover.xml```

### 4. Coverage per file and in percentage
